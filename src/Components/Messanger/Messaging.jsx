    ...
    return (
        ...
        >
            <div className='header_messaging'>
                ...
                <div> <svg className='icon2 ' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="black" className="mercado-match" width="16" height="16" focusable="false">
