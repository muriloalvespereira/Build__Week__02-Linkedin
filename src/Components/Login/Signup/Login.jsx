...
function Login() {
    return (
        <div id="logo-main-container" class="container-fluid d-flex flex-column align-content-center p-0">
            ...
            <div class="container  d-flex flex-column justify-content-center align-items-center mt-4 mb-3 mod-logo-maxWidth">
            ...
            <main class="container-fluid">
                ...
                <div class="container mt-4 mb-3 d-flex justify-content-center align-items-center mod-logo-maxWidth p-3">
                    <div class="section-line"></div>
                    <span class="mx-3 orModtranslate">or</span>
                    <div class="section-line"></div>
                ...
                <div class="container d-flex flex-column mod-logo-maxWidth">
                    ...
                    <p class="mt-4 text-success text-center loginp"><span><a href="">Forgot your password?</a></span></p>
                ...
                <div class="container mod-logo-maxWidth mt-4">
                    <p class="text-center loginp">If you click "Log in with Facebook" and are not a Linkedin user, you will be registered
