        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto nav-icons">
            <Nav.Link className="d-flex flex-column justify-content-center align-items-center small-inlink position-relative">
              ...
              <span className="margherita">Home</span>
            ...
            >
              ...
              >
                <img
                  className="avatar"
                  width="24"
                  src="https://media-exp3.licdn.com/dms/image/C4D03AQEKmFGdeuoSQw/profile-displayphoto-shrink_100_100/0/1625334640822?e=1632355200&amp;v=beta&amp;t=6mX7pit2IAerIiSNcPHWLstAzfNQkPa5RfasVJVzSXc"
                  height="24"
                  alt="Rafael Lima"
                  id="ember34"
                />
            ...
            >
              ...
              <div className="d-flex align-items-center">
                <span className="mr-1 nav-link-span">Work</span>
                <TriangleIcon></TriangleIcon>
              </div>
            </Nav.Link>
            <Nav.Link className="nav-link-span d-flex flex-column justify-content-center align-items-center small-inlink premium-inlink">
