            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    <Nav.Link className="d-flex flex-column justify-content-center align-items-center">
                        <svg id="global-nav-icon--mercado__home" height="24" width="24">
                    ...
                    <Nav.Link className="d-flex flex-column justify-content-center align-items-center">
                        <svg id="global-nav-icon--mercado__messaging" height="24" width="24">
                    ...
                    <Nav.Link className="d-flex flex-column justify-content-center align-items-center">Work</Nav.Link>
                    <Nav.Link className="d-flex flex-column justify-content-center align-items-center">Try Premium Free for 1 Month</Nav.Link>
                    <div className="nav-item dropdown">
                        {/* {Need to put logic do toggle show/hide} */}
                            <a ariaHaspopup="true" ariaExpanded="false" id="basic-nav-dropdown" className="dropdown-toggle nav-link d-flex flex-column justify-content-center align-items-center" role="button">
                                <img width="24" src="https://media-exp3.licdn.com/dms/image/C4D03AQEKmFGdeuoSQw/profile-displayphoto-shrink_100_100/0/1625334640822?e=1632355200&amp;v=beta&amp;t=6mX7pit2IAerIiSNcPHWLstAzfNQkPa5RfasVJVzSXc" height="24" alt="Rafael Lima" id="ember34"/>
                                Me
                            </a>
                            <div ariaLabelledby="basic-nav-dropdown" className="dropdown-menu" style={{margin: "0px"}}>
                                <div style={{height: "64px", width:"64px", backgroundColor:"black"}}></div>
                                </div>
                    </div>
                </Nav>
            </Navbar.Collapse>
