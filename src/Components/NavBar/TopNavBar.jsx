...
function TopNavBar() {
    return (
        <Navbar id="NavBar" className=" container p-0">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" className="Linkedin-Logo">
                    <title>
                        LinkedIn
                    </title>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    ...
                    <Nav.Link className="d-flex flex-column justify-content-center align-items-center small-inlink border-left-Work">
