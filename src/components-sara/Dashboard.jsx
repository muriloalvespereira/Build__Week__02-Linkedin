    ...
    <div className="dashboard">
      ...
      <div className="dashboard-bottom-container">
        ...
        <div className="mynetwork">
          <a href="" className="">
            <div className="mynetwork-content dashboard-section__cta">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                data-supported-dps="24x24"
        ...
        <div className="salary-insights">
          <a href="">
            <div className="salaryinsights-content dashboard-section__cta">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                data-supported-dps="24x24"
        ...
        <div className="myitems d-flex">
          <a href="">
            <div className="myitems-content dashboard-section__cta">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                data-supported-dps="24x24"
